defmodule Licensir.FileAnalyzer do
  ...
  @files [
    ...
    bsd_3_clause: ["BSD-3.txt", "BSD-3.variant-2.txt", "BSD-3.variant-3.txt", "BSD-3.variant-4.txt", "BSD-3.variant-5.txt"],
    bsd_2_clause: ["BSD-2.txt", "BSD-2.variant-2.txt", "BSD-2.variant-3.txt"],
    cc0: ["CC0-1.0.txt"],
    gpl_v2: ["GPLv2.txt"],
    gpl_v3: ["GPLv3.txt"],
